...
<section class="page-header">
    ...
    <div class="container">
        <div class="page-header__inner">
            <!-- <h2>Aircraft Scheduling & Planning</h2> -->
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="<?php echo base_url()?>">Home</a></li>
                <li><span>/</span></li>
                <li><a href="<?php echo base_url().'services'?>">Services</a></li>
                <li><span>/</span></li>
                <li>Aircraft Scheduling & Planning</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__right">
                    <div class="service-details__content-box">
                        ...
                        <h3 class="service-details__title">Aircraft Scheduling & Planning</h3>
                        <p class="service-details__text-1">PLEXUS performs all the below aspects of aircraft and flight
                            crew scheduling and planning with a sophisticated piece of software, ensuring that all
                            flights are conducted within regulatory limits and at the highest level of safety.</p>
                    </div>
                    <br>
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6">
                                <ul class="list-unstyled service-details__benefit-points">
                                    <li>
                                        ...
                                        <div class="text">
                                            <p>Flight Schedule Graphic Screen</p>
                                        </div>
                                    </li>
                                    <li>
                                        <img class="w-30"
                                            src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                        <div class="text">
                                            <p>Handling Maintenance Events</p>
                                        </div>
                                    </li>
                                    <li>
                                        <img class="w-30"
                                    ...
                                    <li>
                                        <img class="w-30"
                                            src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                        <div class="text">
                                            <p>Schedule Conflict Management</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="list-unstyled service-details__benefit-points">
                                    ...
                                    <li>
                                        <img class="w-30"
                                            src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                        <div class="text">
                                            <p>Aircraft Flying Hours Distribution</p>
                                        </div>
                                    </li>
                                    <li>
                                        <img class="w-30"
                                    ...
                                    <li>
                                        <img class="w-30" style="margin-top: -27px"
                                            src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                        <div class="text">
                                            <p>Automated Aircraft Movement Messages</p>
                                        </div>
                                    </li>
                ...
                <div class="service-details__left">
                    <div class="service-details__category">
                        <ul class="service-details__category-list list-unstyled">
                            ...
                            <li><a href="<?php echo base_url().'services/permits#permitsSec'?>">Permits<span
                                        class="fas fa-angle-right"></span></a></li>
                            ...
                            <li class="active"><a
                                    href="<?php echo base_url().'services/aircraft_scheduling_planning#aircraftScheduling'?>">Aircraft
                            ...
                            <li><a href="<?php echo base_url().'services/crew_support#crewSupport'?>">Crew Support<span
                                        class="fas fa-angle-right"></span></a></li>
                            <li id="aircraftScheduling"><a href="<?php echo base_url().'services/global_concierge#globalConcie'?>">Global
