                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="service-details__left">
                            <div class="service-details__content-box">
                                ...
                                <h3 class="service-details__title">Flight Dispatch</h3>
                                <p class="service-details__text-1">The fligh Dispatch department takes control of the aircraft’s day-to-day operations, including the planning and monitoring of each flight along with the safety of the flight with the flight crews. Dispatchers conduct all of the necessary pre-planning, flight-watching, en-route assistance, and coordination of every flight - 24 hours a day, 7 days a week.</p>
                                        ...
                                        <ul class="list-unstyled service-details__benefit-points">
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Flight Logs/Record Keeping </p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Computerized Flight Plan-ETOPS</p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                                        ...
                                        <ul class="list-unstyled service-details__benefit-points">
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Flight Watching/Flight Monitoring </p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                        ...
                        <div class="service-details__right">
                            <div class="service-details__category">
                                <ul class="service-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a
                                            href="<?php echo base_url().'services/flight_dispatch#flightDispatch'?>">Flight
                                    ...
                                    <li><a href="<?php echo base_url().'services/crew_support#crewSupport'?>">Crew Support<span
                                                class="fas fa-angle-right"></span></a></li>
                                    <li id="flightDispatch"><a href="<?php echo base_url().'services/global_concierge#globalConcie'?>">Global
