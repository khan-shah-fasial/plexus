            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__content-box">
                        ...
                        <h3 class="service-details__title">Fuel</h3>
                        <p class="service-details__text-1">The major element involved in operating a flight
                            around the world is fuel services. PLEXUS has its own
                            fuel department, which provides refuel services by
                            directly purchasing fuel from fuel providers and
                            supplying this fuel to various clients, thereby aiding
                            to a cost-effective planning.</p>
                ...
                <div class="service-details__right">
                    <div class="service-details__category">
                        <ul class="service-details__category-list list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo base_url().'services/fuel#fuelSec'?>">Fuel<span
                                        class="fas fa-angle-right"></span></a></li>
                            ...
                            <li><a href="<?php echo base_url().'services/crew_support#crewSupport'?>">Crew Support<span
                                        class="fas fa-angle-right"></span></a></li>
                            <li id="fuelSec"><a href="<?php echo base_url().'services/global_concierge#globalConcie'?>">Global
