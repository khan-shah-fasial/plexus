                ...
                <div class="col-xl-8 col-lg-7">
                        <div class="service-details__left">
                            <div class="service-details__content-box">
                                ...
                                <h3 class="service-details__title">Crew Support</h3>
                                <p class="service-details__text-1">We offer a wide range of Crew services, right from
                                    scheduling
                                    to planning to having all ancillary support provided to the crew members.</p>
                            </div>
                                        ...
                                        <ul class="list-unstyled service-details__benefit-points">
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Fatigue Risk Management System</p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Ground Transportation Services</p>
                                                </div>
                                            </li>
                                        ...
                                        <ul class="list-unstyled service-details__benefit-points">
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Travel Insurance Arrangements</p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Travel Expense Managements</p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                        ...
                        <div class="service-details__right">
                            <div class="service-details__category">
                                <ul class="service-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a href="<?php echo base_url().'services/crew_support#crewSupport'?>">Crew
                                            Support<span class="fas fa-angle-right"></span></a></li>
                                    <li id="crewSupport"><a href="<?php echo base_url().'services/global_concierge#globalConcie'?>">Global
