                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="service-details__left">
                            ...
                            <div class="service-details__content-box">
                                ...
                                <h3 class="service-details__title">Flight Support</h3>
                                <p class="service-details__text-1">Flight Support covers the complex series of
                                    processes and procedures required to service
                                    arriving and departing aircraft, their crew and passengers .</p>
                                    ...
                                    <div class="col-xl-6">
                                        <ul class="list-unstyled service-details__benefit-points">
                                            <li>
                                                ...
                                                <div class="text">
                                                    <p>Ground Handling Arrangements</p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Airport Slots Coordination </p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                                        ...
                                        <ul class="list-unstyled service-details__benefit-points">
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Ambulance Service Arrangements</p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                                            ...
                                            <li>
                                                <img class="w-30"
                                                    src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                                <div class="text">
                                                    <p>Aircraft Maintenance Assistance</p>
                                                </div>
                                            </li>
                                            <li>
                                                <img class="w-30"
                        ...
                        <div class="service-details__right">
                            <div class="service-details__category">
                                <ul class="service-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a
                                            href="<?php echo base_url().'services/flight_support#flightSupport'?>">Flight Support<span
                                    ...
                                    <li><a href="<?php echo base_url().'services/crew_support#crewSupport'?>">Crew Support<span
                                                class="fas fa-angle-right"></span></a></li>
                                    <li id="flightSupport"><a href="<?php echo base_url().'services/global_concierge#globalConcie'?>">Global
