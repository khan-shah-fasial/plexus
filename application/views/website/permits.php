        ...
        <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__content-box">
                        ...
                        <h3 class="service-details__title">Permits</h3>
                        <p class="service-details__text-1">Flight Permits are required by an aircraft to enter, pass, overfly, land, or make a technical stop in an airspace. Every country comes with its own set of rules, regulations, and processes to follow. Our team, with its expertise and resources, and mainly through experience, has established exceptional relationships with civil Aviation Authorities all across the globe, mainly with the DGCA of India, our home country. We assist you in obtaining fast and hassle-free permission to make the planning of your trips easier. We cater to all types of Overflight, Landing, Diplomatic, Military, Block permits, VIP Flight permissions, and clearances around the world.</p>
                            ...
                            <div class="col-xl-12">
                                <div class="service-details__benefit-content">
                                    ...
                                    <ul class="list-unstyled service-details__benefit-points">
                                        <li>
                                            <img class="w-30"
                                                src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                            <div class="text">
                                                <p>Landing Permits Arrangements</p>
                                            </div>
                                        </li>
                                        <li>
                                            <img class="w-30"
                                                src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                            <div class="text">
                                                <p>Overflight Clearances Arrangements</p>
                                            </div>
                                        </li>
                                        <li>
                                            <img class="w-30"
                                                src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                            <div class="text">
                                                <p>Block Permit For Commercial / Cargo Flights</p>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <img class="w-30"
                                                src="<?php echo base_url().'web-assets/images/shapes/flight.png'?>">
                                            <div class="text">
                                                <p>Transport Security Administration “TSA” Permits For USA</p>
                                            </div>
                                        </li>
                ...
                <div class="service-details__right">
                    ...
                    <div class="service-details__category">
                        <ul class="service-details__category-list list-unstyled">
                            ...
                            <li><a href="<?php echo base_url().'services/trip_planning#tripPlaning'?>">Trip Planning Service
                                    <span class="fas fa-angle-right"></span></a>
                            </li>

                            <li><a href="<?php echo base_url().'services/flight_support#flightSupport'?>">Flight Support<span
                                        class="fas fa-angle-right"></span></a></li>

                            <li><a href="<?php echo base_url().'services/flight_dispatch#flightDispatch'?>">Flight
                                    Dispatch<span class="fas fa-angle-right"></span></a></li>

                            <li class="active"><a href="<?php echo base_url().'services/permits#permitsSec'?>">Permits<span
                                        class="fas fa-angle-right"></span></a></li>

                            <li><a href="<?php echo base_url().'services/fuel#fuelSec'?>">Fuel<span
                                        class="fas fa-angle-right"></span></a></li>

                            <li><a href="<?php echo base_url().'services/aircraft_scheduling_planning#aircraftScheduling'?>">Aircraft
                                    Scheduling & Planning<span class="fas fa-angle-right"></span></a></li>
                            <li><a href="<?php echo base_url().'services/crew_support#crewSupport'?>">Crew Support<span
                                        class="fas fa-angle-right"></span></a></li>
                            <li id="permitsSec"><a href="<?php echo base_url().'services/global_concierge#globalConcie'?>">Global
