        ...
        <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__content-box">
                        ...
                        <p class="service-details__text-1">Flight Permits are required by an aircraft to enter, pass,
                            overfly, land or make a technical stop in an airspace. Every country comes with its own set
                            of rules, regulations and process to follow. Our team with the expertise, resources and
                            mainly thru experience has established exceptional relationships with Civil Aviation
                            Authorities all across the globe and mainly with Indian DGCA being our home country. We
                            assist you in obtaining fast and hassle-free permission to benefit easy planning of your
                            trips. We cater to all type of Overflight, landing, Diplomatic, Military, Block permits, VIP
                            Flight permission and clearances around the world.</p>
                ...
                <div class="service-details__right">
                    ...
                    <div class="service-details__category">
                        <ul class="service-details__category-list list-unstyled">
                            ...
                            <li><a href="<?php echo base_url().'services/trip_planning'?>">Trip Planning Service
                            ...
                            <li class="active"><a href="<?php echo base_url().'services/permits'?>">Permits<span
                                        class="fas fa-angle-right"></span></a></li>
